...
// api
import { useGetPost, useGetPosts,useSearchPosts } from 'src/api/blog';
...
export default function PostListView() {
  ...
  // const {posts , postsLoading} = useGetPost("Post Item title")
  // const title = "Post54";
  // const {post ,postLoading} = useGetPost("Post17")
